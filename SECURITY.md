...
If you discover a security vulnerability in Avi Builder, please report it responsibly.
...
This policy applies to the Avi Builder application code in this repository. For issues related to third-party services (Supabase, Vercel), please report to those providers directly.
