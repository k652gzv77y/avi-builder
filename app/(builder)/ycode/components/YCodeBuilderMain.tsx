        ...
        <div className="w-full max-w-sm animate-in fade-in slide-in-from-bottom-1 duration-700" style={{ animationFillMode: 'both' }}>
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-6">
            ...
            <div className="flex flex-col items-center gap-4">
              <button
                type="button"
                className="flex min-h-[60px] w-full items-center justify-center gap-2 rounded-[7px] border-0 bg-white px-6 py-[15px] text-[20px] leading-none text-black transition-colors hover:bg-neutral-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white disabled:cursor-not-allowed disabled:opacity-60 sm:px-[70px] sm:text-[25px]"
                style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", sans-serif' }}
                disabled={isLoggingIn}
                onClick={() => handleOAuthLogin('apple')}
              >
                <span className="text-[1.15em] leading-none" aria-hidden="true"></span>
                Sign in with Apple
              </button>
              <button
                type="button"
                className="flex min-h-[60px] w-full items-center justify-center gap-3 rounded-[7px] border-0 bg-white px-6 py-[15px] text-[20px] leading-none text-black transition-colors hover:bg-neutral-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white disabled:cursor-not-allowed disabled:opacity-60 sm:px-[70px] sm:text-[25px]"
                style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", sans-serif' }}
                disabled={isLoggingIn}
