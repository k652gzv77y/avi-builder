...
export const utilityTemplates: Record<string, BlockTemplate> = {
  ...
  slide: {
    ...
    template: {
      ...
      design: {
        ...SLIDE_BASE_DESIGN,
        backgrounds: { isActive: true, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundImage: '--bg-img', bgImageVars: { '--bg-img': 'url(/projects/kolbo-school/layouts/assets/placeholder-2.webp)' } },
      },
      restrictions: { ancestor: 'slides' },
      variables: {
        backgroundImage: { src: { type: 'dynamic_text', data: { content: '/projects/kolbo-school/layouts/assets/placeholder-2.webp' } } },
      },
      children: [
        {
          name: 'heading',
    ...
    template: {
      ...
      children: [
        // Slides wrapper with 3 default slides
        {
          ...
          open: true,
          children: [
            createSlideRef('Slide 1', '/projects/kolbo-school/layouts/assets/placeholder-2.webp'),
            createSlideRef('Slide 2', '/projects/kolbo-school/layouts/assets/placeholder-3.webp'),
            createSlideRef('Slide 3', '/projects/kolbo-school/layouts/assets/placeholder-7.webp'),
          ],
        },
